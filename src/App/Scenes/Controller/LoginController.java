...
public class LoginController extends BaseSceneController {
    ...
    public void loginBtnClick() throws Exception {
        if(getVisibility("nomeField")){
            inizializzaLabel("erroreNomeLabel");
            inizializzaLabel("erroreCognomeLabel");
            inizializzaLabel("erroreEmailLabel");
            inizializzaLabel("errorePasswordLabel");
            inizializzaLabel("erroreTelefonoLabel");
            inizializzaLabel("erroreDatanascitaLabel");
